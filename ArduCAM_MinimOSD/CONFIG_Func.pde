...
void writeSettings() {
 ...
 writeEEPROM(11, panPitch_x_ADDR);
 writeEEPROM(1,  panPitch_y_ADDR);
 writeEEPROM(on, panRoll_en_ADDR);
 writeEEPROM(23, panRoll_x_ADDR);
 writeEEPROM(9,  panRoll_y_ADDR);
 ...
 writeEEPROM(16, panHeading_x_ADDR);
 ...
 writeEEPROM(2,  panHomeDis_y_ADDR);
